 ...
 */
public class Trends_New_Grad_Students extends Fragment {
    ...
    public Trends_New_Grad_Students(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setText("New Graduate Students");
...
//        valueSet1.add(v1e4);
        BarEntry v1e5 = new BarEntry(1526.000f, 0);
        valueSet1.add(v1e5);
        BarEntry v1e6 = new BarEntry(1381.000f, 1);
        valueSet1.add(v1e6);
        BarEntry v1e7 = new BarEntry(1344.000f, 2);
        valueSet1.add(v1e7);
        BarEntry v1e8 = new BarEntry(1394.000f, 3);
        valueSet1.add(v1e8);
        BarEntry v1e9 = new BarEntry(1520.000f, 4);
        valueSet1.add(v1e9);
        BarEntry v1e10 = new BarEntry(1555.000f, 5);
        valueSet1.add(v1e10);
