 ...
 */
public class Trends_New_Undergrad_Transfers extends Fragment {
    ...
    public Trends_New_Undergrad_Transfers(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setText("New Undergraduate Transfers");
...
//        valueSet1.add(v1e4);
        BarEntry v1e5 = new BarEntry(2451.000f, 0);
        valueSet1.add(v1e5);
        BarEntry v1e6 = new BarEntry(2492.000f, 1);
        valueSet1.add(v1e6);
        BarEntry v1e7 = new BarEntry(2523.000f, 2);
        valueSet1.add(v1e7);
        BarEntry v1e8 = new BarEntry(2643.000f, 3);
        valueSet1.add(v1e8);
        BarEntry v1e9 = new BarEntry(2921.000f, 4);
        valueSet1.add(v1e9);
        BarEntry v1e10 = new BarEntry(2968.000f, 5);
        valueSet1.add(v1e10);
